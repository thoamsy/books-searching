...
function BooksGridSkeleton() {
  return (
    <>
      ...
      <div className="@container mt-6 grid grid-cols-2 gap-4 @md:grid-cols-3 @3xl:grid-cols-4 @3xl:gap-5 @5xl:grid-cols-5 @5xl:gap-6">
  ...
  return (
    <>
      ...
      {books.length === 0 ? (
        ...
        <div className="@container mt-6 grid grid-cols-2 gap-x-4 gap-y-6 @md:grid-cols-3 @3xl:grid-cols-4 @3xl:gap-x-5 @5xl:grid-cols-5 @5xl:gap-x-6">
          {books.map((book) => {
